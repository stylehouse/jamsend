...
`Doc:Ghost/test/Story/Lake/LakeAntecedents.g` and `Point,method:Peeroleum`.  The flush (encode /
...
- working clones = [`Doc:Ghost/test/Story/Lake/LakeAntecedents.g`, `Point,method:Peeroleum`]
