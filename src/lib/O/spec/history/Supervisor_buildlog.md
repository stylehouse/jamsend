# Supervisor buildlog — the diary that used to be `Supervisor_todo.md` §0

> **Historicity notice.** This is the reverse-chronological build diary of the Supervisor, lifted
>  out of `src/lib/O/spec/Supervisor_todo.md` §0 on **2026-08-12**, where it had reached **1,710
>   lines** and had stopped being readable — the owner, 2026-08-11: *"§0 is such sludge. can you do
>    up something a bit more well structured for me to read. no idea what asking."*
>
> It is kept **whole and unedited** because it is authoritative for **HOW** each thing landed, and
>  because several entries carry measurements that exist nowhere else. What it is NOT is a statement
>   of what is currently true or currently open — a long diary has no register, so an aside written
>    under a date becomes indistinguishable from a ruling, and re-reading this to find "open
>     questions" mints decisions nobody ever asked for (that failure is recorded in the entry for
>      `%Caper`/`%Pull`, withdrawn as doc noise by the owner).
>
> **The living content went to:**
> - **`src/lib/O/spec/Supervisor_todo.md` §0** — now a brief: current state and what is open.
> - **`src/lib/O/spec/V1_cut_todo.md`** — the triage built from this diary: what ships, what waits,
>    what needs the owner's word.
> - `Supervisor_todo.md` §§1–10 — unchanged, and still the design.
>
> Entries below run newest-first, 2026-08-11 back to 2026-08-09.
