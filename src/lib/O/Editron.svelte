<script lang="ts">
    ...
    //   Run_A_Editron below (the Run_A_<Book> recipe, mirroring Run_A_Peregrination).
    //
    ...
    await M.eatfunc({
        ...
        //   Run_A_Peregrination wires the test runner's.  The actors must live in the Run so its
