...
//
//   Paths on disk:
//     toc  → wormhole/Story/HohoTiles/toc.snap   (derived by Lies_waft_snap_path)
//     step → wormhole/Story/HohoTiles/NNN.snap   (a raw snap string per step)
//
// ── Structure ─────────────────────────────────────────────────────────────────
//
...
const WH_PATH      = 'Story/HohoTiles'

// ── dm_step_path ─────────────────────────────────────────────────────────────
//   Zero-padded snap path for a given step number.
//   Story/HohoTiles/003.snap etc — stable naming, no collisions.
