<script lang="ts">
    ...
    Ghostmeta_Ghost_Story_Musuation(): string { return 'dd2f6aa225174296' },
...
MusuSignal_witness(w) {
    ...
    if (hplayed === hof && hunder === 0 && hgaps === 0 && hof > 0 && !(w.oa({witnessed: "streams"}))) w.i({witnessed: "streams"})
    ...
    if (sunder > 0 && sgaps > 0 && !(w.oa({witnessed: "starves"}))) w.i({witnessed: "starves"})
