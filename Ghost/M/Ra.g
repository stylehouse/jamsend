...
// THE SP ISLAND MOVED OUT (2026-09-17, SoundPooling_todo.md §0.2a/STEP 2 — "yes to Pool.g, definitely
//  looks big enough"): Pool_knobs / Pool_is_machinery / Pool_facts / Pool_policy / Pool_policy_compare
//   now live in Ghost/M/Pool.g, unchanged (a file move, no behaviour change). They still call back into
//    this ghost by name (Ra_pool_owner, Ra_pool_consent_of, Ra_pool_home, Ra_pool_stock, Ra_recs,
//     Ra_home_self, Ra_home_shop, Ra_pool_hash, Radio_pub, Ra_quarter_tally, &c.) exactly as any
//      cross-ghost `this.` call does elsewhere.
