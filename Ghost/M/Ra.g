...
// THE QUARTERMASTER MOVED OUT (2026-09-17): the pool steward — Ra_quarter_* / Ra_pool_* (define · home · consent ·
//  excuse · budget · caps · compartments · goal_pools · diff · roll · serve) and Ra_upgrade_scan — now live in
//   Ghost/M/Pool.g beside the pure policy island, unchanged (a file move). Cross-ghost `this.` calls resolve as before.
...
// THE POOL-FILL REACH MOVED OUT (2026-09-17): Ra_pool_fill_* / heal / cull / pump — Ghost/M/Pool.g.
