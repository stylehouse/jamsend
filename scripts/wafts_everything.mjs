...
W.push(['Ghost/Music/Ality', 'the music pipeline — rastock racast raterm — stock a track then cast it then play it at the terminal — the radio dials and the pool keeps what played',
 ...
 ['What:the pool', 'SoundPooling — the dial already chooses so the pool keeps what played — consent budget caps and the quarter goal',
  'Doc:Ghost/M/Pool.g', P('Pool_facts', 'everything the policy decides on — gathered once a pass'), P('Pool_policy', 'the pure goal→diff→roll — decides nothing yet'), P('Pool_policy_compare', 'the live diff vs the pure one — said once per shape'), P('Ra_pool_define', 'a pool — who owns it'), P('Ra_pool_stock', 'what the pool holds'), P('Ra_pool_consent', 'who consented to pool'), P('Ra_pool_budget', 'bytes allowed'), P('Ra_pool_census', 'count the pool'), P('Ra_quarter_goal_pools', 'the quarter — how much each source should give — per compartment off one tally'), P('Ra_pool_fill_book', 'book a fill'), P('Ra_pool_fill_homes', 'where a fill comes from and lands'), P('Ra_pool_fill_verdict', 'did the fill land'),
...
W.push(['Ghost/Music/Cave', 'the collection — heist original bytes into the Cave — the keep chooses — the Heard Mag is the ledger of love — a phone hands its loves to the laptop',
 ...
 ['What:the rummage', 'soft heist — words and leads — a wish hardens into a pull',
  'Doc:Ghost/M/Heist.g', P('Heist_rummage_recs', 'rummage a shelf'), P('Heist_rummage_wire', 'rummage over the wire'), P('Heist_blag_folder', 'take a whole folder')],
 ...
 ['What:the heard', 'the Heard Mag is the ledger — a Card per track per pub — love takes and unlove unwants — verdicts and the unseen mark',
  'Doc:Ghost/M/Heard.g', P('Heard_mag', 'the Mag per pub'), P('Heard_card', 'the Card per track'), P('Heard_take', 'a reaction — yay — re-affirms on a later press never unloves'), P('Heard_nay', 'a reaction — not in my pool never drawn again'), P('Heard_meh', 'a reaction — an early skip radio-written'), P('Heard_taken', 'is it loved'), P('Heard_verdict', 'what happened to the take'), P('Heard_notice', 'mark unseen on arrival'), P('Heard_unseen', 'how many unseen'), P('Heard_gc', 'the clock that forgets'), P('Heard_clone_beat', 'copy verdicts across')],
...
W.push(['Ghost/Vis/Visua', 'the visual — the crush that gangs leaves — the glass that cuts cells from the model — what a Book looks like while it runs',
 ['VoroMitosis','VoroScape','VoroRadio','VoroClinic','VoroTest','VytoStaple','VytoCell','VytoMitosis','VytoTandem','VytoFreeze','VytoSeek','VytoCrest','VytoFold','VytoBunch','VytoFoam','VytoBreathe','VytoNest','VytoMemo','VytoNeed','VytoDepth','VytoOrchestra','VytoMembrane','VytoGuise'], [
